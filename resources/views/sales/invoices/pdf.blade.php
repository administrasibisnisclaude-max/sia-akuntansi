...
<body>
        ...
        <tr>
            ...
            <td class="text-right">
                <table style="margin-left:auto;">
                    <tr><td style="padding:2px 8px;">No. Faktur</td><td><strong>{{ $invoice->invoice_number }}</strong></td></tr>
    ...
    <table class="totals">
        ...
        <tr><td>PPN (11%)</td><td class="text-right">Rp {{ number_format($invoice->tax_amount, 0, ',', '.') }}</td></tr>
        @endif
